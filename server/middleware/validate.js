...
const registerSchema = Joi.object({
  ...
  // Contact
  contact_number:  Joi.string().pattern(/^09\d{9}$/).required()
                     .messages({ 'string.pattern.base': 'Must be a valid PH mobile number (09XXXXXXXXX)' }),
...
const updateProfileSchema = Joi.object({
  contact_number:    Joi.string().pattern(/^09\d{9}$/).optional(),
